...
```text
Input ประกอบไปด้วย a, b, d และ r โดยจำนวนนับเริ่มตั้งแต่ a จนถึง b โดยแสดงจำนวนที่หารด้วย d แล้วเหลือเศษ = r Output คือ จำนวนของเลขทั้งหมดที่เข้าเงื่อนไขดังกล่าว​
```
...
```text
แผนแรกคือการนำ d + r เพื่อหา แต่หากพิจารณา​ดี ๆ จะสังเกตได้ว่า r ที่นำมาใช้จะเยอะกว่าความเป็นจริง เพราะเศษ​เหลือควรจะมีครั้งเดียว จริงใช้วิธีการตรง ๆ โดยสร้างลูปมาเพื่อเช็คทีละค่าว่าค่านั้นหาร d และเหลือเศษ r หรือไม่
```
...
```text
ใช้วิธีการดังที่กล่าวไป และจะสร้างค่าตัวแปรเก็บจำนวนของตัวเลข โดยค่อย ๆ เพิ่มขึ้นหากตัวเลขในลูปเข้าเงื่อนไข
```
...
```text
เพราะเป็นเทสเคสที่โจทย์​กำหนดมาให้และช่วยเช็คในระดับนึงว่าวิธีคิดของโค้ดถูกต้อง
```
