...
```text
input คือ ผลสลากกินแบ่งและสลากที่กระต่ายน้อยซื้อ output คือ จำนวนเงินที่กระต่ายจะได้ตามเงื่อนไข
```
...
```text
ใช้วิธีการเช็คว่าเข้าเงื่อนไขใดบ้างตามที่โจทย์กำหนดมา โดยเช็คทั้งตัวอักษรและหมายเลข
```
...
```text
ใ้ช้ตามวิธีแรก โดยปริ้นจำนวนเงินที่กระต่ายจะได้ออกมา หากไม่ตรงตามเงื่อนไขใดให้แสดง 0
```
...
```text
เพราะเป็นเทสเคสที่โจทย์กำหนดมาให้และกระต่ายถูกรางวัลที่หนึ่ง
```
...
```text
เพราะเป็นเทสเคสที่โจทย์กำหนดมาให้และหมายเลขถูกแต่ตัวอักษรผิด
```
...
```text
เพราะเป็นเทสเคสที่โจทย์กำหนดมาให้และตัวอักษรถูกแต่หมายเลขผิด
```
