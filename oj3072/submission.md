...
```text
Input คือ string ที่ต้องการจะหา และ Output​ คือจำนวนสระในภาษาอังกฤษ​แต่ละตัวที่มีอยู่ใน string โดยไม่สนใจพิมพ์​เล็กหรือพิมพ์​ใหญ่
```
...
```text
เริ่มจากการนำ input มาเปลี่ยนให้กลายเป็น lower ทั้งหมด แล้วนำมาเปรียบเทียบทีละเงื่อนไขว่าเข้าเงื่อนไขของสระใดบ้างและแสดงจำนวนสระนั้น ๆ ออกมา
```
...
```text
ใช้วิธีการเดียวกับแผนแรก โดยใช้ if ในทุกสระเพื่อให้แสดงออกมาได้ครบถ้วน และหากไม่มีสระนั้น ๆ ก็จะไม่แสดงออกมา
```
...
```text
เพราะเป็นเทสเคสที่โจทย์​กำหนดให้
```
...
```text
เพราะมีสระที่เป็นทั้งตัวพิมพ์​ใหญ่​และ​พิมพ์​เล็ก
```
