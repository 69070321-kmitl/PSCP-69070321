...
```text
input  คือ หมายเลขและสัญลักษณ์ ของไพ่ output คือ การเปลี่ยนจากตัวย่อให้กลายเป็นคำ
```
...
```text
เริ่มจากการตัดตัวสุดท้ายของ input (สัญลักษณ์) ออกก่อน เพื่อเช็คว่าเป็นหมายเลขหรือ ควีน คิง แจ็ค หรือ เอซ ถ้าไม่ใช่ตัวเลขให้ปริ้น ควีน คิง แจ็ค หรือ เอซ ตัวเต็มออกมา คั่นด้วย of และเช็คว่าตัวสุดท้ายคือสัญลักษณ์อะไรและปริ้นคำเต็มออกมา
```
...
```text
ใช้ตามวิธีแรก โดยเวลาตรวจสอบจะเปลี่ยนเป็น upper ก่อนเสมอเพื่อป้องกัน lower case
```
...
```text
เพราะเป็นเทสเคสที่ีโจทย์กำหนดมาให้และหมายเลขเป็นควีน
```
...
```text
เพราะเป็นเทสเคสที่โจทย์กำหนดมาให้และหมายเลขเป็นตัวเลข
```
...
```text
เพราะตัวย่อของสัญลักษณ์เป็น lower case
```
