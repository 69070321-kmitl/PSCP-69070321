...
```text
input คือ เมืองที่อยู่และเมืองที่ต้องการส่งไป และ output คือราคาค่าส่งที่จะต้องจ่าย โดยราคาจากเมือง a ไปเมือง b จะไม่เท่ากับจากเมือง b ไปเมือง a และไม่ใช่ทุกเมืองจะสามารถเดินทางถึงกันได้
```
...
```text
ตอนแรกเริ่มต้นจากการพยายามหาแพทเทิร์นของแต่ละเมืองที่เชื่อมกัน แต่เมื่อวิเคราะห์แพทเทิร์นที่สังเกตดูแล้ว อาจจะกลายเป็นการเพิ่มความยาวและซับซ้อนของโค้ดเกินไปโดยไม่จำเป็น จึงใช้กาารเขียน if-else โดยตรงแทน
```
...
```text
ใช้วิธีเขียน if-else โดยตรงตามเงื่อนไขของเมืองและราคาที่โจทย์กำหนด และหากเส้นทางนั้นไม่อยู่ในเงื่อนไขจะแสดงเป็น Error
```
...
```text
เพราะเป็นเทสเคสที่โจทย์กำหนด เส้นทางมีอยู่ในเงื่อนไข และผลลัพธ์เป็นจำนวนเต็ม
```
...
```text
เพราะเป็นเทสเคสที่โจทย์กำหนด เส้นทางมีอยู่ในเงื่อนไข และผลลัพธ์เป็นทศนิยม
```
...
```text
เพราะเป็นเทสเคสที่โจทย์กำหนดและเส้นทางไม่อยู่ในเงื่อนไข
```
