...
```text
input คือจำนวนเริ่มต้นและจำนวนสุดท้าย output คือ จำนวนเฉพาะทั้งหมดที่อยู่ในช่วงนั้น
```
...
```text
การเช็คจำนวนเฉพาะจะต้องเช็คผลหารจำนวนก่อนหน้าทุกจำนวน เริ่มต้นที่ 2 จึงเริ่มต้นจากการสร้างลิสต์มา 2 ลิสต์ คือ​ลิสต์​ตั้งแต่ 2 ถึง ก่อนเลขเริ่มต้น และอีกลิสต์​ไว้รับค่าจำนวนเฉพาะหลังเช็ค โดยจะถือว่าเป็นจำนวนเฉพาะก็ต่อเมื่อจำนวนนั้นหารทุกจำนวนในทั้ง 2 ลิสต์​ไม่ลงตัวเลย
```
...
```text
ใช้ตามวิธีการแรก โดยสร้างตัวแปรค่าความจริงมาเก็บค่าความจริง หากมีการหารแล้วลงตัว ค่านี้จะเป็นจริง และจะไม่เพิ่มจำนวนดังกล่าว​ลงในลิสต์
```
...
```text
เพราะเป็นเทสเคสที่​โจทย์​กำหนด​และเริ่มต้นที่ 1
```
...
```text
เพราะเป็นเทสเคสที่โจทย์​กำหนด​และไม่มีจำนวนเฉพาะเลย
```
...
```text
เพราะมีเลขติดลบและไม่มีจำนวน​เฉพาะ​เลย
```
