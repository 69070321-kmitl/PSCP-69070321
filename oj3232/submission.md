...
```text
input คือ ระยะทางที่กบกระโดดได้้ต่อครั้งในตอนแรก และ ระยะทางทั้งหมด output คือ จำนวนที่กบกระโดดจนกว่าจะถึงเป้าหมาย โดยที่ระยะทางที่กบกระโดดได้จะลดลง 2 เมตรทุกครั้ง และหากกบกระโดดไปไม่ถึงเป้าหมายให้แสดง  -1
```
...
```text
ใช้ while loop เงื่อนไขว่า ถ้าหากระยะทางที่กบรกะโดดได้ หรือ ระยะทางระหว่างกบและเป้าหมาย <= 0 จะออกจากลูปและเช็คว่า ระยะทางระหว่างกบและเป้าหมายเหลือหรือไม่
```
...
```text
ใช้ตามวิธีแรก โดยในลูป ระยะทางที่กบจะสามารถกระโดดได้ก็จะค่อย ๆ ลดลงครั้งละ 2 เมตร และ ระยะทางเป้าหมายจะค่อย ๆ ลดลงตามครั้งที่กบกระโดดเช่นกัน
```
...
```text
เพราะเป็นเทสเคสที่โจทย์กำหนดให้และกบสามารถกระโดดไปถึงเป้าหมาย
```
...
```text
เพราะเป็นเทสเคสที่กบไม่สามารถกระโดดถึงเป้าหมายได้
```
...
```text
เพราะเป็นเทสเคนสที่โจทย์กำหนดให้และกบไม่สามารถกระโดดถึง
```
