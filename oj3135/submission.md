...
```text
input ประกอบไปด้วย จำนวนคนนั่งล้อมวงทัังหมด จำนวนการนับคนถัดไป และ ลำดับของโจร output คือ จำนวนของคนที่จะได้จับของขวัญจนกว่าของขวัญจะวนกลับมาคนที่ 1 หรือไปอยู่ในมือโจร
```
...
```text
เริ่มต้นจากการสร้างตัวแปรขึ้นมาเตรียมรับค่า 2 ตัว โดยตัวแรกรับค่าจำนวนจำนวนคนทั้งหมดที่จะได้จับของขวัญ และอีกตัวเพื่อรับค่าลำดับของคนที่กำลังถือของขวัญในปัจจุบัน โดยเริ่มจากการเช็คว่าคนแรกเป็นโจรหรือไม่ หากไม่ ไปคิดลำดับของคนถัดไป และเช็คว่าคนนั้นเป็นคนที่ 1 หรือเป็นโจรหรือไม่
```
...
```text
ใช้วิธีตามแผนแรก โดยคิดคนลำดับถัดไปด้วยการนำ ลำดับปัจจุบัน + step และนำมา % จำนวนคนทั้งหมด เพื่อให้ลำดับคนไม่เกินกลุ่ม และถ้าหากวนแล้วมาอยู่ในมือโจร จะเพิ่มจำนวนคนไป 1 แต่ถ้าหากวนกลับมาคนแรกจะไม่มีการบวกเพิ่ม
```
...
```text
เพราะเป็นการเช็คการคิดเลขและลำดับว่าถูกต้องหรือไม่
```
...
```text
เพราะเป็นเทสเคสที่โจทย์​กำหนด​ให้​
```
