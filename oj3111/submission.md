...
```text
input ประกอบไปด้วย การเป็นสมาชิก จำนวนสิ่งของที่ซื้อ และราคาของสิ่งที่ซื้อ และoutput คือราคาที่ต้องจ่าย โดยทีเงื่อนไขว่าถ้าหากเป็นสมาชิกจะลดราคา 5% แต่ถ้าหากไม่เป็นสมาชิกและยอดรวมมากกว่าหรือเท่ากับ 500 บาท จะลดราคา 3%
```
...
```text
เริ่มจากการรับค่าเข้ามา และสร้างเงื่อนไขว่าเป็นสมาชิกหรือไม่ ถ้าหากไม่ ซื้อสินค้าเกิน 500 หรือไม่ และสุดท้ายแสดงราคาออกมาเป็นทศนิยม 2 ตำแหน่ง
```
...
```text
ใช้ตามวิธีแรกแต่สังเกตเห็นว่าคำตอบใกล้เคียงแต่ทศนิยมปัดไม่ตรงกับเทสเคสจึงพยายามหาวิธีแก้ปัญหาโดย import decimal เข้ามาช่วยเรื่องทศนิยม แต่ก็สังเกตเทสเคสอีกหนึ่งเคสได้ว่าเลขหลักสิบไม่ตรงกับoutput เมื่อลองส่งดูจึงพบว่าผ่านและน่าจะเป็นความผิดพลาดของเคสตัวอย่าง
```
...
```text
เพราะเป็นเทสเคสที่โจทย์กำหนดมาให้และเป็นจำนวนเต็ม
```
