...
```text
input คือ จำนวนของเครื่องหมายทั้งหมดที่ต้องการใส่ และเครื่องหมายบวกลบ โดยที่บวก คือการ +10 และลบคือ -5 ทีละตัว output คือ ผลลัพธ์สุดท้าย
```
...
```text
เริ่มต้นจากการสร้างตัวแปรมารับค่าผลลัพธ์​สุดท้าย จากนั้นสร้างลูปและรับค่าจำนวนรอบเข้ามา และเช็คว่าเป็นการบวกหรือลบ
```
...
```text
ใช้ตามวิธีการแรก โดยดำเนินการตามเครื่องหมายที่เช็คได้ และแสดงค่าผลลัพธ์​ออกมาตอนสุดท้าย
```
...
```text
เพราะเป็น​เท​ส​เคสที่​โจทย์​กำหนด​ให้
```
...
```text
เ​พราะเป็น​เท​ส​เคสที่​โจทย์​กำหนด​ให้​
```
