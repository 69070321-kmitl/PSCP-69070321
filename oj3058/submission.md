...
```text
Input ประกอบไปด้วย จำนวนของอิฐขนาด 1 นิ้ว จำนวนของอิฐขนาด 5 นิ้ว และความยาวของสะพานที่ต้องการจะสร้าง โดย Output คือจำนวนของก้อนอิฐ​ขนาด 1 นิ้วที่ใช้ไป แต่ถ้าหากจำนวนก้อนอิฐ​ทั้งหมดไม่สามารถ​สร้างสะพานให้พอดีกับความยาวได้ ให้แสดง -1
```
...
```text
ที่เงื่อนไขแรก เริ่มต้นจากการเช็คว่าจำนวนอิฐ 5 นิ้วสามารถ​สร้างสะพานได้พอดีโดยไม่ต้องใช้อิฐ 1 นิ้วหรือไม่ ถ้าหากไม่ นำมาเช็คต่อว่ามันเยอะเกินหรือขาด ถ้าหากเกิน ก็จะสามารถ​นำความยาวสะพานมาหารเอาเศษได้เลย แต่ถ้าหากขาดก็จะนำความยาวของอิฐ 5 นิ้วทั้งหมดมาลบ หลังจากนั้นจึงเอาความยาวมาลบกับอิฐ 1 นิ้ว แล้วจึงนำมาเช็คในเงื่อนไขสุดท้ายว่า = 0 หรือติดลบหรือไม่ หากใช่ หมายความว่าเพียงพอ ส่วนที่ติดลบนั้นคือความยาวที่ไม่ต้องการ สามารถ​นำมาหักออกจากจำนวนอิฐ 1 นิ้วได้เลย แต่ถ้าหากมากกว่า 0 หมายความว่าไม่สามารถ​ทำได้
```
...
```text
ใช้วิธีตามแผนแรก โดยถ้าหากเงื่อนไขแรกเป็นเท็จ จะหมายความว่าไม่ต้องใช้อิฐ 1 นิ้วและแสดง 0 และถ้าหากอิฐ 1 นิ้วไม่พอจะแสดง  -1
```
...
```text
เพราะเป็นเทสเคสที่โจทย์​กำหนดมาให้และใช้อิฐจนครบพอดี
```
...
```text
เพราะเป็นเทสเคสที่โจทย์​กำหนดมาให้และจำนวนอิฐทั้งหมดไม่พอ
```
...
```text
เพราะความยาวของอิฐ​ 5 นิ้วเกินความยาวของสะพาน แต่ถ้าหากพยายามคิดให้พอดี จำนวนอิฐทั้งหมดจะไม่พอ
```
