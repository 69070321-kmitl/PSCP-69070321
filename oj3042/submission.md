...
```text
 input คือ จำนวนเต็มบวกที่ต้องการทราบ output คือ จำนวนที่ 10 หารลงตัว เรียงจากมากไปน้อย จนถึง 0
```
...
```text
เริ่มจากการสร้าง list เข้ามาเก็บแต่ละค่าที่จะ print นำเลขจาก input มาทำการหารปัดเศษด้วย 10 แล้วใช้วิธีการวนลูป ค่อย ๆ เพิ่มแต่ละค่าเข้าไปใน list และลดไปทีละค่าจนถึงเลข 0
```
...
```text
ใช้วิธีการเหมือนกับแผนแรก โดยในการเพิ่มแต่ละตัวเข้าไปใน list จะคูณ 10 กลับเข้าไป
```
...
```text
เพราะเป้นเทสเคสที่โจทย์กำหนดมาและเป็นจำนวนที่หาร 10 ลงตัว
```
...
```text
เพราะเป้นเทสเคสที่โจทย์กำหนดมาให้และเป็นจำนวนที่ 10 หารไม่ลงตัว
```
